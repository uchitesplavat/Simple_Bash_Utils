...
for var in -bt -b -e -n -s -t -v #-E -T --number-nonblank --number --squeeze-blank
do
          TEST1="$var $TEST_FILE"
          echo "$TEST1"
...
for var in -b -bt -e -n -s -t -v #-E -T --number-nonblank --number --squeeze-blank
do
...
for var in -bt -b -e -n -s -t -v #-E -T --number-nonblank --number --squeeze-blank
do
  for var2 in -ns -b -e -n -s -t -v #-E -T --number-nonblank --number --squeeze-blank
  do
      for var3 in -ev -b -e -n -s -t -v #-E -T --number-nonblank --number --squeeze-blank
      do
